...
public class VehicleDAO {
	...
	public void addVehicle(Vehicle vehicle) {
        JdbcTemplate jdbct = new JdbcTemplate(getDataSource());
		String sql = "INSERT INTO Vehicle (brand, model, colour, engine, registrationno) VALUES ('" + vehicle.getBrand() + "', '" + vehicle.getModel() + "', '" + vehicle.getColour() + "', '" + vehicle.getEngine() + "', '" + vehicle.getRegistrationno() + "')";
		jdbct.update(sql);
    }
	...
	public void updateVehicle(Vehicle vehicle) {
		JdbcTemplate jdbct = new JdbcTemplate(getDataSource());
		String sql = "UPDATE Vehicle SET brand = '" + vehicle.getBrand() + "', model = '" + vehicle.getModel() + "', colour = '" + vehicle.getColour() + "', engine = '" + vehicle.getEngine() + "', registrationno = '" + vehicle.getRegistrationno() + "' WHERE vehicleid = '" + vehicle.getVehicleid() + "'";
		jdbct.update(sql);
	}
