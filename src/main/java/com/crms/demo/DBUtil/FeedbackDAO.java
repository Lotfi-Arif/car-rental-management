...
public class FeedbackDAO {
  ...
  public void addFeedback(Feedback feedback) {
    ...
    String sql =
      "INSERT INTO Feedback (fullname, feedback, date) VALUES ('" +
  ...
  public List<Feedback> viewFeedback() {
    JdbcTemplate jdbct = new JdbcTemplate(getDataSource());
    String sql =
      "SELECT fullname, feedback, DATE_FORMAT(date, '%d-%m-%Y') AS date FROM Feedback";
    List<Feedback> fList = jdbct.query(
      sql,
