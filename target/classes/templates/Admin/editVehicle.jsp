  ...
  <body>
    ...
    <div class="content-container">
      ...
      <div class="content">
        ...
        <div>Click on the appropiate action buttons.</div>
        <br />

        <div class="edit-button">
          <form method="post" action="viewAllVehicle">
            <input
              type="submit"
          ...
          <form method="post" action="viewAddVehicle">
            <input
              type="submit"
              class="form-button2 fas fa-plus-circle"
              value="&#xf055; Add"
            />
          </form>
        </div>
              ...
              <td>
                <div class="columnbttn">
                  ...
                  >
                    ...
                    <input
                      type="submit"
                      class="form-button fa fa-edit"
                      value="&#xf044;"
                    />
                  </form>
                  <form class="formbttn" method="post" action="deleteVehicle">
                    <input
                      type="hidden"
                      name="vehicleid"
                      th:value="${vehicle.vehicleid}"
                    ...
                    <input
                      type="submit"
                      class="form-button fas fa-trash-alt"
                      value="&#xf2ed;"
                    />
                  </form>
                </div>
