	...
	<div class="content">
		...
		<div class="table">
			<table class="my-table w3-table w3-striped w3-bordered">
				...
				<tr>
					<td><input type="text" name="brand" placeholder="Brand name.." required></td>
					<td><input type="text" name="model" placeholder="Model name.." required></td>
					<td><input type="text" name="colour" placeholder="Vehicle's colour.." required></td>
					<td><input type="text" name="engine" placeholder="Vehicle's engine.." required></td>
					<td><input type="text" name="regno" placeholder="Vehicle's registration no" required></td>
				</tr>
