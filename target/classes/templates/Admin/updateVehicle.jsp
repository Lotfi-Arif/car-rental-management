...
<div class="content-container">
	...
	<div class="content">
		<div class="title">Update Vehicle</div>
		<div>Update the vehicle details and then click save.</div><br>
		...
		<div class="table">
			<form method="post" action="updateVehicle">
				<table>
					<tr>
						<td><input type="hidden" name="vehicleid" th:value="${vehicle[0].vehicleid}"></td>
					</tr>
					<tr>
						<th>Brand</th>
						<td><input type="text" name="brand" th:value="${vehicle[0].brand}" required></td>
					</tr>
					<tr>
						<th>Model</th>
						<td><input type="text" name="model" th:value="${vehicle[0].model}" required></td>
					</tr>
					<tr>
						<th>Colour</th>
						<td><input type="text" name="colour" th:value="${vehicle[0].colour}" required></td>
					</tr>
					<tr>
						<th>Engine</th>
						<td><input type="text" name="engine" th:value="${vehicle[0].engine}" required></td>
					</tr>
					<tr>
						<th>Registration No.</th>
						<td><input type="text" name="regno" th:value="${vehicle[0].registrationno}" required></td>
					</tr>
					<tr>
