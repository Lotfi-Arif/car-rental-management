  ...
  <body>
    ...
    <div class="content-container">
      ...
      <div class="content">
        ...
        <div>Update the vehicle details and then click save.</div>
        <br />
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    name="regno"
                    th:value="${vehicle[0].registrationno}"
                    required
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="submit"
                    class="form-button2 fa fa-floppy-o"
                    value="&#xf0c7; Save"
                  />
                </td>
              </tr>
