    ...
    <div class="right-design">
      <div class="sign-in-form">
        ...
        <p>
          ...
          <a href="registerPage.jsp">Login here!</a>
        </p>
        <br />
        <form method="post" action="indexController.jsp">
          <label for="email" class="function"><strong>Email</strong></label
          ><br />
          <input
            class="input-box"
            type="text"
            ...
            required
          /><br /><br />
          <label for="username" class="function"
          ...
          <input
            ...
            required
          /><br /><br />
          <label for="password" class="function"
          ...
          /><br /><br />
          <label for="password" class="function"
            ><strong>Retype Password</strong></label
          ><br />
          <input
            class="input-box"
            type="password"
